...
function M.get(config)
  ...
  theme = {
    ...
    ['@tag.attribute'] = { fg = p.blue3, style = styles.normal },
    ['@text'] = { fg = p.text },
    ...
    LspSignatureActiveParameter = { fg = p.pink3 ,bg = p.blueGray3 },
    ...
    TelescopeSelection = { fg = p.text, bg = p.blueGray3 },
    TelescopeSelectionCaret = { fg = p.blue3, bg = p.blueGray3 },
